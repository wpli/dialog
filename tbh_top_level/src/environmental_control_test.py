...
sys.path.append( '../../tbh_environmental_control/src/' )
import tbh_environmental_control 
...
#Initialize the environmental control module
ec = tbh_environmental_control.tbh_environmental_control_t()
...
dm.add_environmental_control_handler( ec.execute_action_handler )
