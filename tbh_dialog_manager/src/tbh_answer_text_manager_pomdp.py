...
def get_answer_text( action_code, skype_contacts_dict=None ):
    ...
    elif parameter[0] == 'request_keyword':
        desired_text = get_request_keyword_text( action_code )

    elif base_code == 'null':
        desired_text = get_did_not_understand_text( action_code )
...
def get_did_not_understand_text( action_code ):
    parameter = action_code[1][0]
    if parameter == 'yes_record':
        desired_text = "Sorry, I'm not sure I know what you want. Please try again."
    elif parameter == 'no_record':
        desired_text = "Sorry, I'm not sure I know what you want. Please try again."

    return desired_text
    
def request_keyword_text( action_code ):
    parameter = action_code[1][0]
    desired_text = "Please say the keyword at the start of your statement."
