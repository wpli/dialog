...
class tbh_state_matplotlib_thread:
    """
    ...
    def __init__( self ):
        ...
        # Set up the GUI part
        self.state_matplotlib = AppForm( self.queue, self.endApplication )
...
class AppForm(QMainWindow):
    def __init__(self, queue, end_command, parent=None):
        ...
        self.textbox.setText('0.01 0.01 0.01 0.01')
        self.on_draw()
    ...
    def update_state_handler( self ):
        print "HELLO WORLD, I AM IN THE STATE_MATPLOTLIB"
...
if __name__ == "__main__":
    ...
    state_matplotlib_thread = tbh_state_matplotlib_thread()
