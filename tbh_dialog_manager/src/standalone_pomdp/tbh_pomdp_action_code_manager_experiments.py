...
action_code_file = "../../dialog_system_tools/bin/20120118/decision_process_files/actions.txt"
...
if __name__ == '__main__':
    ...
    print get_number_action_code( action_code_list, [ 'confirm', 'time', 'time' ] )
    print get_number_action_code( action_code_list, [ 'phone', 'make_phone_call' ] )
