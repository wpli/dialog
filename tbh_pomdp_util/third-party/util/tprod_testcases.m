...
X=complex(randn(11,11,11),randn(11,11,11));
Y=complex(randn(11,11),randn(11,11));
...
scalingTests([128 96 64 48 40 32 24 16 0],[128,256,512,1024,2048]);
...
function []=scalingTests(blkSzs,Ns);
% Scaling test
