...
pomdp.reward = [ 0 1; 1 0];
pomdp.transition( : , : , 1 ) = [ 0.5 0.5 ; 0.5 0.5 ];
pomdp.transition( : , : , 2 ) = [ 0.5 0.5 ; 0.5 0.5 ];
pomdp.observation( : , : , 1 ) = [ 0.8 0.8 ; 0.2 0.2 ];
pomdp.observation( : , : , 2 ) = [ 1 1 ; 0 0 ];
